#!/usr/bin/env python3
"""
Compute Pearson Delta baseline using centroids with hierarchical summaries.

This script implements a baseline for drug response prediction using pre-computed
centroid embeddings. It computes mean perturbation effects from training data 
and evaluates predictions on test data using Pearson correlation between predicted
and true deltas. All computations maintain strict plate boundaries to avoid batch effects.
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Compute Pearson Delta baseline using centroids",
