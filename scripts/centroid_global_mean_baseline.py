...
def main():
    ...
    output_file = f"{args.output_dir}/global_mean{abs_suffix}_detailed_correlations.csv"
    full_df.to_csv(output_file, index=False)
    print(f"Saved detailed correlations to: {output_file}")

    # Save summaries as JSON
    summary_file = f"{args.output_dir}/global_mean{abs_suffix}_hierarchical_summaries.json"
