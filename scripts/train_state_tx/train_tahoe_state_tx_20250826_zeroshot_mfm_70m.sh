...
CONFIG_FILE="${SCRIPT_DIR}/tahoe_5_holdout/zeroshot_generalization_converted_cell_lines_70m.toml"
OUTPUT_DIR="/tahoe/drive_3/ANALYSIS/analysis_190/Code/train_state_tx/experiments"
EXPERIMENT_NAME="tahoe_state_tx_$(date +%Y%m%d_%H%M%S)_MFM70M_hvg_full"
...
state tx train \
    ...
    wandb.tags="[tahoe,zeroshot,drug_cell_split,mosaicfm_70m_merged]" \
