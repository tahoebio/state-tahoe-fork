...
CONFIG_FILE="/tahoe/drive_3/ANALYSIS/analysis_190/Code/state-tahoe-fork/scripts/train_state_tx/parse_pbmc_holdout/donor.toml"
OUTPUT_DIR="/tahoe/drive_3/ANALYSIS/analysis_190/Code/train_state_tx/experiments"
EXPERIMENT_NAME="parse_state_adaptation_tx_$(date +%Y%m%d_%H%M%S)_Tx1-70M_hvg_full"
...
state tx train \
    ...
    model.kwargs.init_from=/tahoe/drive_3/ANALYSIS/analysis_190/Code/train_state_tx/experiments/tahoe_state_tx_20250812_165301_MFM_hvg_full/checkpoints/final.ckpt \
    model=tahoe_llama_212693232 \
    wandb.tags="[parse,fewshot,adaptation,donor,Tx1-70M]" \
