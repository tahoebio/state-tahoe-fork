...
CONFIG_FILE="/tahoe/drive_3/ANALYSIS/analysis_190/Code/state-tahoe-fork/scripts/train_state_tx/parse_pbmc_holdout/donor_se.toml"
...
state tx train \
    ...
    model.kwargs.init_from=/tahoe/drive_3/ANALYSIS/analysis_190/Code/train_state_tx/experiments/tahoe_state_tx_20250827_001649_SE_hvg_full/checkpoints/final.ckpt \
