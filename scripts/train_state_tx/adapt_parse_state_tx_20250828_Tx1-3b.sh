...
CONFIG_FILE="/tahoe/drive_3/ANALYSIS/analysis_190/Code/state-tahoe-fork/scripts/train_state_tx/parse_pbmc_holdout/donor_tx13b.toml"
OUTPUT_DIR="/tahoe/drive_3/ANALYSIS/analysis_190/Code/train_state_tx/experiments"
EXPERIMENT_NAME="parse_state_adaptation_tx_$(date +%Y%m%d_%H%M%S)_Tx1-3B_hvg_full"
