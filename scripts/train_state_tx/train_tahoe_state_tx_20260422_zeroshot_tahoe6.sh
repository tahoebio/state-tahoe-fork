...
CONFIG_FILE="${SCRIPT_DIR}/tahoe_6_holdout/zeroshot_generalization_converted_cell_lines.toml"
OUTPUT_DIR="/nvme-shared/models/train_state_tx"
EXPERIMENT_NAME="tahoe_state_tx_$(date +%Y%m%d_%H%M%S)_zeroshot_tahoe6"
