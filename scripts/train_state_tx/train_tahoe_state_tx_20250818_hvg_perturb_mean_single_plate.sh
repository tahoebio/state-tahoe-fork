...
CONFIG_FILE="${SCRIPT_DIR}/tahoe_5_holdout/generalization_converted_cell_lines_single_plate.toml"
OUTPUT_DIR="/tahoe/drive_3/ANALYSIS/analysis_190/Code/train_state_tx/experiments"
EXPERIMENT_NAME="tahoe_state_tx_$(date +%Y%m%d_%H%M%S)_HVG_hvg_full_perturb_mean_single_plate1"
