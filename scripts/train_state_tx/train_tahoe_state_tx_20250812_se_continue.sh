...
EXPERIMENT_NAME="tahoe_state_tx_20250812_165635_SE_hvg_full"
...
state tx train \
    ...
    model.kwargs.init_from='/tahoe/drive_3/ANALYSIS/analysis_190/Code/train_state_tx/experiments/tahoe_state_tx_20250812_165635_SE_hvg_full/checkpoints/step250000.ckpt' \
